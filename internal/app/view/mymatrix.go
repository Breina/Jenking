...
func NewMyMatrixView(t theme.Theme, client jmodel.JenkinsClient, store *cache.Store, scope NavigationContext, slowInterval time.Duration) *MyMatrixView {
...
func (mv *MyMatrixView) ParentView(t theme.Theme, c jmodel.JenkinsClient, s *cache.Store) View {
	if mv.inner == nil {
		return nil
	}
