...
func newTestReportBehavior(t theme.Theme, client jmodel.JenkinsClient, store func() *cache.Store, access buildAccessor, navigate navigateCmd) *testReportBehavior {
...
func (b *testReportBehavior) resolve() (nc NavigationContext, build jmodel.Build, report *jmodel.TestReport, ok bool) {
	store := b.store()
	if store == nil {
		return
	}
...
func (b *testReportBehavior) Shortcut() (component.Shortcut, bool) {
	...
	return component.ViewSCRanked("T", "tests: "+badge, false, rankViewTests), true
}
