...
type HasParent interface {
	ParentView(t theme.Theme, c jmodel.JenkinsClient, s *cache.Store) View
}
...
func folderParentJobList(t theme.Theme, c jmodel.JenkinsClient, s *cache.Store, childPath, username string, gitUsernames []string) View {
