...
func (s *stubValidator) ValidateJenkinsfile(_ context.Context, _ string) (jmodel.ValidationResult, error) {
	s.calls.Add(1)
...
func TestRunVimValidator_WritesErrorsOnChange(t *testing.T) {
	...
	stub := &stubValidator{result: jmodel.ValidationResult{
		OK:     false,
		Issues: []jmodel.ValidationIssue{{Line: 7, Col: 3, Message: "boom"}},
	}}
...
func TestRunVimValidator_ClearsOnPass(t *testing.T) {
	...
	stub := &stubValidator{result: jmodel.ValidationResult{OK: true}}
